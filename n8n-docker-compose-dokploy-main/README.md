...
![Create Project](./assets/dokploy-creat-project-zenploy.jpg)

### Step 2: Add a Service

Click **Create Service** → Select **Template** from the options.

![Create Service](./assets/dokploy-creat-service-zenploy.jpg)

### Step 3: Pick the n8n Template

Choose **"n8n with Postgres"** (the 2nd option) → Click **Create**.

![Select n8n Template](./assets/dokploy-n8n-templatect-zenploy.jpg)
...
![Deploy Docker Compose](./assets/dokploy-deploy-docker-compose-zenploy.jpg)
...
![Environment Settings](./assets/dokploy-environment-settings-zenploy.jpg)

### Step 6: First Deploy

Go to **General** tab → Click **Deploy** to start.

![Deploy](./assets/dokploy-deploy-zenploy.jpg)

### Step 7: Watch It Build

Check the logs to make sure everything's working. You'll see PostgreSQL and n8n starting up.

![Deployment Details](./assets/dokploy-deployment-details-zenploy.jpg)
...
![Domain Configuration](./assets/dokploy-domains-zenploy.jpg)
...
![Set Up Owner Account](./assets/n8n-set-up-owner-account.jpg)
